...
const SKILLS_CATEGORIES = [
  ...
  },
  {
    id: "frontend",
    label: "Frontend",
    eyebrow: "L'interface qui tient en prod",
  ...
  },
  {
    ...
    eyebrow: "En complément de la stack web",
